...
- [x] **EXTR-04**: An eval set of 5–10 hand-labeled fitness videos (plus 1 non-fitness control) is checked in and used to gate real-pipeline ship; failure to extract the control as "no workout" blocks release
