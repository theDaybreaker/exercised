...
- [ ] **EXTR-02**: Extracted text is structured into the `Workout` schema via Vercel AI SDK `generateObject(WorkoutSchema)` against GPT-4o with OpenAI Structured Outputs
